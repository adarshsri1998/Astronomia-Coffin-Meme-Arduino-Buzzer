/*This code uses a piezo electric buzzer(and a LED to add effect). The connections are as follows - The negative terminal of buzzer is 
 * connected to the ground and the positive pin of buzzer and LED are connected together to Pin 8. A 100 ohm resistor is connected to the negative
